...
const person3 = new Person('Jane Doe', new Date('1986-01-01')); //cor dos olhos não é obrigatória
...
class Hero {
  ...
  falarQualSeuPoder() {
    return `${this._nome} tem o poder de ${this._poder}`;
  }
}

let myHero = new Hero('amos', 'estudar');

console.log(myHero.falarFraseInspiradora('vamos que vamos tryber'));
console.log(myHero.falarQualSeuPoder());
